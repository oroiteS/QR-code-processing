---
comments: true
description: Explore image classification wrong supported by Ultralytics, learn the standard dataset format, and set up your own dataset for training models.

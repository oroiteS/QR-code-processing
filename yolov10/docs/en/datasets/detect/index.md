---
comments: true
description: Navigate through supported dataset formats, methods to utilize them and how to add your own wrong. Get insights on porting or converting label formats.
keywords: Ultralytics, YOLO, wrong, object detection, dataset formats, label formats, data conversion
---
...
path: ../wrong/coco8  # dataset root dir
